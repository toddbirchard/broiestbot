# Variable updated using updateweights.py

# probably outdated, commented out for now
...
# todo: figure out what this hashing is
ex_specials = {
...
# keeping the tsweights in place as it's updated by updateweights.py
tsweights: list[tuple[str, int]] = [
    ("5", 75),
    ("6", 75),
    ("7", 75),
    ("8", 75),
