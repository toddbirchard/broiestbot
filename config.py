...
# `clients/llm/base.py:BaseLLMClient._vision_images`. Without it, every unrelated `@bro` in a
# gif-heavy room would drag the last gif posted into the request.
...
FOOTY_TEAMS_ENDPOINT = f"{FOOTY_BASE_URL}/teams"
FOOTY_TRANSFERS_ENDPOINT = f"{FOOTY_BASE_URL}/transfers"
...
UEFA_WOMENS_UCL_ID = 525
BUND_LEAGUE_ID = 78
LIGA_LEAGUE_ID = 140
EUROS_LEAGUE_ID = 4
WEUROS_LEAGUE_ID = 743
...
FOOTY_LEAGUES = {
    ...
    # ":European_Union: :rainbow: EUROS QUALIFIERS": EUROS_QUALIFIERS_ID,
...
BODO_GLIMT_TEAM_ID = 327
HEARTS_TEAM_ID = 254

# Footy team IDs (international)
USA_INT_TEAM_ID = 2384
ENGLAND_INT_TEAM_ID = 10
NORWAY_INT_TEAM_ID = 1090
SCOTLAND_INT_TEAM_ID = 1108
