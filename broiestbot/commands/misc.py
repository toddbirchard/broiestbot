...
def nontent_time_remaining(user_name: str) -> str:
    """
    Calculate remaining time until EAFC nontent is released.

    :param str user_name: Username of the user requesting the time remaining.
